...
const ProjectsSlider = () => {
  ...
  const animateObject = (i: number) => {
    if (isSmall)
      ...
      return selected != i
        ...
        : { height: "60vh", width: "100%", opacity: 1 };
  };
  ...
  return (
    <div className="w-full flex flex-col space-y-20 items-start">
      ...
      <div className="flex lg:flex-row flex-col space-y-0 space-x-0 w-full divide-y-3 lg:divide-y-0 lg:divide-x-3 divide-white  lg:aspect-[15/5] lg:overflow-hidden ">
        {projects.map((e, i) => (
          <motion.div
            key={i}
